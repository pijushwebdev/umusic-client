      ...
      <div ref={sliderRef} className="keen-slider mb-10">
        <div className="keen-slider__slide number-slide1 relative ">
          <div className=" overflow-hidden">
            <img
              ...
              src="https://i.ibb.co/qDnCYRy/modern-microphone.jpg"
              alt=""
            />
          </div>
          ...
          <div className="absolute left-3 md:left-10 md:top-10 lg:top-32 top-0 z-10">
            <div className="content">
              <h2 className="lg:text-8xl md:text-4xl text-2xl font-extrabold mt-5 md:mt-10 text-white">
                Vocal <span className="block">Recording</span>
              </h2>
            </div>

            <Slide>
              <p className="md:my-6 my-2 text-sm text-slate-300 font-normal md:font-medium w-full lg:w-1/2">
                Vocal recording, in essence, is capturing the voice of the
                artist in the most effective and efficient way so that the
                play-back will be as true sounding to the original performance
                as possible.{" "}
              </p>
        ...
        <div className="keen-slider__slide number-slide2 relative ">
          <div className=" overflow-hidden">
            <img
              className="bg-animation w-full"
              src="https://i.ibb.co/z4Jzkd2/female-student-playing-piano.jpg"
              alt=""
            />
          </div>
          ...
          <div className="absolute left-3 md:left-10 lg:top-32 md:top-10 top-0 z-10">
            <div className="content">
              <h2 className="lg:text-8xl md:text-4xl text-2xl font-extrabold mt-5 md:mt-10 text-white">
                Piano <span className="block">Courses</span>
              </h2>
            </div>

            <Slide>
              <p className="md:my-6 my-2 text-sm text-slate-300 font-normal md:font-medium w-full lg:w-1/2">
                Piano comes from the original Italian name for the instrument:
                piano e forte, soft and loud.Piano is also the musical notation
                that tells the player that something should be played quietly.{" "}
              </p>
            </Slide>
        ...
        <div className="keen-slider__slide number-slide3 relative ">
          <div className="overflow-hidden">
            <img
              className="bg-animation w-full"
              src="https://i.ibb.co/YWndFwJ/man-with-guitar-darkness.jpg"
              alt=""
            />
          </div>
          ...
          <div className="absolute left-3 md:left-10 lg:top-32 md:top-10 top-0 z-10">
            <div className="content">
              <h2 className="lg:text-8xl md:text-4xl text-2xl font-extrabold mt-5 md:mt-10 text-white">
                Guitar <span className="block">Courses</span>
              </h2>
            </div>

            <Slide>
              <p className="md:my-6 my-2 text-sm text-slate-300 font-normal md:font-medium w-full lg:w-1/2">
                You can definitely learn on an electric guitar, but overall,
                acoustic guitar wins out every time. Its easier to sound good,
                easier to play and its easier to learn{" "}
              </p>
            </Slide>
